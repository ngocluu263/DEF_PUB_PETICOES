...
public class MessageBox
{
    ...
    {
        this.msgbox_ok_button = "<input id=\"btnMsgOK\" type=\"button\" value=\"OK\" AccessKey=\"O\" class=\"" + msg_button_class + "\" onClick=\"document.getElementById('pagedimmer').style.visibility = 'hidden'; document.getElementById('msgbox').style.visibility = 'hidden';\">";
    }

    public void SetOKButton(string msg_button_class, string pageRedirect)
    {
        this.msgbox_ok_button = "<input id=\"btnMsgOK\" type=\"button\" value=\"OK\" AccessKey=\"O\" class=\"" + msg_button_class + "\" onClick=\"document.getElementById('pagedimmer').style.visibility = 'hidden'; document.getElementById('msgbox').style.visibility = 'hidden'; window.open('" + pageRedirect + "','_parent');\">";
    }

    public void SetOKButton(string msg_button_class, string pageRedirect, bool confirm)
    {
        this.msgbox_ok_button = "<input id=\"btnMsgOK\" type=\"button\" value=\"OK\" AccessKey=\"O\" class=\"" + msg_button_class + "\" onClick=\"document.getElementById('pagedimmer').style.visibility = 'hidden'; document.getElementById('msgbox').style.visibility = 'hidden'; return confirm('teste'); window.open('" + pageRedirect + "','_parent');\">";
    }
