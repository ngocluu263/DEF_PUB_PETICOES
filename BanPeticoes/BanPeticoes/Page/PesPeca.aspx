<%@ Page Title="" Language="C#" MasterPageFile="~/Page/Site.master" AutoEventWireup="true" CodeFile="PesPeca.aspx.cs" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" Runat="Server">
    <ul class="nav navbar-nav side-nav">
        ...
        <li class="active"><a href="PesPeca.aspx"><i class="fa fa-search-minus"></i> Pesquisa Geral</a></li>
            ...
            <div class="row">
                <div class="col-md-11 col-md-offset-0">
                    ...
                    <ul class="nav nav-tabs faq-cat-tabs">
                        <li class="active"><a href="#faq-cat-1" data-toggle="tab">Pesquisa Geral</a></li>
                    </ul>
                    ...
                    <div class="panel-group" id="accordion-cat-1">
                         <div class="panel panel-primary">
                              <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-file-text-o"></i> Pesquisa de Peça Jurídica Geral</h3>
                              </div>
                              <div class="panel-body">
                                <div class="col-lg-6">
                                   <div class="form-group">
                                       <label>Matéria</label>
                                       <asp:DropDownList ID="ddlTipoMateriaGer" runat="server" cssClass="form-control"></asp:DropDownList>
                                   </div>
                                   <div class="form-group">
                                       <label>Peça</label>
                                       <asp:DropDownList ID="ddlTipoPecaGer" runat="server" cssClass="form-control"></asp:DropDownList>
                                   </div>                                
                                    <p>
                                        <asp:Button ID="btnPesquisarGeral" runat="server" CssClass = "btn btn-primary" 
                                            Text="Pesquisar" onclick="btnPesquisarGeral_Click" />
                                    </p>
                                </div>
                                <div class="col-lg-11">
                                <div class="EU_TableScroll" id="showData" style="display: block">
                                    <asp:GridView ID="gvPeca" runat="server" CssClass="EU_DataTable" 
                                        AllowPaging="True" DataKeyNames="PECN_ID" width="100%" 
                                        AutoGenerateColumns="False" onpageindexchanging="gvPeca_PageIndexChanging" 
                                        onselectedindexchanging="gvPeca_SelectedIndexChanging">
                                        <Columns>
