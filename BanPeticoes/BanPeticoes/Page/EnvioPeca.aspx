...
CodeFile="EnvioPeca.aspx.cs" ValidateRequest="false" Trace="false" Inherits="EnvioPeca" culture="auto" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" Runat="Server">
    <ul class="nav navbar-nav side-nav">
        ...
        <li class="active"><a href="EnvioPeca.aspx"><i class="fa fa-files-o"></i> Envio de Peça Jurídica</a></li>
        <li class="dropdown">
...
<asp:Panel ID="panVisualizacao" runat="server">
    <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1>Envio <small>Peça Jurídica</small></h1>
          </div>
        </div>
