<%@ Page Title="" Language="C#" MasterPageFile="~/Page/Admin/Site.master" AutoEventWireup="true" CodeFile="CadTipoPeca.aspx.cs" 
Inherits="CadTipoPeca" ValidateRequest="false" Trace="false" %>
...
<asp:Panel ID="panAcesso" runat="server" Visible="false">
    <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1>Cadastro <small>Tipos de Peça</small></h1>
          </div>
        </div>
            ...
            <div class="col-lg-12">
                 <div class="panel panel-primary">
                      <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-file-text-o"></i> Controle de Tipos de Peça</h3>
                      </div>
                      <div class="panel-body">
                           <div class="col-lg-6">
                                <asp:Button ID="btnNovo" runat="server" Text="Novo Tipo de Peça" cssClass="btn btn-default" onclick="btnNovo_Click"/>
                           </div>
                           <br />
                           <br />
                           <div class="col-lg-11">
                                <div class="EU_TableScroll" id="showData" style="display: block">
                                    <asp:GridView ID="gvPrincipal" runat="server" CssClass="EU_DataTable" 
                                        AllowPaging="True" DataKeyNames="TPEN_ID" width="100%" 
                                        AutoGenerateColumns="False" 
                                        onselectedindexchanging="gvPrincipal_SelectedIndexChanging" 
                                        onrowdeleting="gvPrincipal_RowDeleting" >
                                        <Columns>
                                            <asp:BoundField DataField="TPEN_ID" Visible="False"></asp:BoundField>
                                            <asp:BoundField DataField="TPEN_DESCRICAO" HeaderText="Peça">
                ...
                <div class="panel-body">
                    <div class="col-lg-6">
                      <div class="form-group">
                          ...
                          <asp:Textbox ID="txtPeca" runat="server" cssClass="form-control" MaxLength="200"></asp:Textbox>
                      </div>
                      <p>
